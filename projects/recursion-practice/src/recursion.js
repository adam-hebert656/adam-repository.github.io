...
var palindrome = function(string) {
  if (!string.length || string.length === 1) {
    ...
    return palindrome(string.slice(1, !string.length ? -1: 1));
  } 
  return false;
};
...
var minimizeZeroes = function(list) {
  ...
  if (list[0] === list[1] && list[0] === 0) {
    return minimizeZeroes(list.slice(1));
  } 
...
var alternateSign = function(array) {
  if (array.length === 0) {
    ...
    return alternateSign(array.slice(0, -1)).concat([ array[array.length - 1] > 0 ? -array[array.length - 1]: array[array.length - 1] ]);
  } else if (array.length % 2 !== 0) {
    return alternateSign(array.slice(0, -1)).concat([ array[array.length - 1] > 0 ? array[array.length - 1]: -array[array.length - 1] ]);
  }
};
