...
function greeter(hour) {
    ...
    // If hour >= 0 and hour <= 11, console log "Good Morning!"
    if (hour >= 0 && hour <= 11) {
        console.log("Good Morning!");
    // If hour >= 12 and hour <= 16, console log "Good Afternoon!"
    } else if (hour >= 12 && hour <= 16) {
        console.log("Good Afternoon!");
    // If hour >= 17 and hour <= 21, console log "Good Evening!"
    } else if (hour >= 17 && hour <= 21) {
        console.log("Good Evening!")
    // If hour >= 22 and hour <= 24, console log " Good Night!"
